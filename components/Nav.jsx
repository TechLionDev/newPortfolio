...
const Nav = ({ user, loggedIn }) => {
            ...
            <Link href="/">
              <div className="flex flex-row items-center justify-center gap-2 text-center">
                <img
                  ...
                  className="w-16"
                  alt="TechLion Dev Logo"
                />
                <strong className="text-2xl logo">TechLion Dev </strong>
              </div>
            </Link>
          </div>
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 flex items-center justify-between p-2 px-6 py-4 bg-blue-100 rounded-b-lg shadow-lg fadeOut">
        <div className="menu">
          <button
            onClick={() => {
              setNavMenuOpen(!navMenuOpen);
